...
Note that this is test code, that's why there are lots of `unwrap()` calls because we don't care about errors (I have [written about `unwrap()` before]({{ site.baseurl }}{% post_url 2017-08-16-replacing-unwrap-and-avoiding-panics-in-rust %})).
